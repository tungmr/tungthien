...
<body>
	...
	<div class="container">
		...
		<div class="hello-user"
			style="display: flex; padding: 8px; justify-content: flex-end; align-content: center; font-size: 20px; padding-bottom: 0;">
			<p>
						...
						<li><div class="cart">
							...
							<ul class="sub-icon1 list">
								...
								<div class="shopping_cart">
									...
									<div class="cart_box">
										<div class="message">
											<div class="alert-close"><a href="CartServlet?c=xoa&idSanPham=<%=list.getValue().getSanPham().getIdSanPham()%>"><img src="images/cancel.png"></a></div>
											<div class="list_img">
											...
											<div class="list_desc">
												...
												<h4 style="font-size: 15px;"><%=formatter.format(list.getValue().getSanPham().getGiaSanPham())%> VNĐ</h4>
											</div>
